...
export module bloom:pipeline.bloom_upsample_computer;

import std;
import glm;
import vkutil;

export class BloomUpsampleComputer {
public:
    ...
    explicit BloomUpsampleComputer(
...
private:
    ...
    [[nodiscard]] auto createPipeline(
        const vk::raii::Device &device) const
    -> vk::raii::Pipeline {
        const vk::raii::ShaderModule shaderModule { device, vkutil::getShaderModuleCreateInfo("shaders/bloom_upsample.comp.spv") };
